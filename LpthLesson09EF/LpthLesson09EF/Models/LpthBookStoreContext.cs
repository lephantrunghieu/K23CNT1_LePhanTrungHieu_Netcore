...
public partial class LpthBookStoreContext : DbContext
{
    public LpthBookStoreContext()
    {
    }

    public LpthBookStoreContext(DbContextOptions<LpthBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-TRL28C8\\SQLEXPRESS;Database=LpthBookStore;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6BBC005AA");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2071BDDCD5D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BF0DCEA9C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFCB1608A3");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C213ED595");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABD29E6751");
